...
data.table::fwrite(data_with_preds, paste0(dir_path, "/output_with_preds.csv"))

# Save RDS files
saveRDS(archive,  paste0(dir_path,  "/archive.rds"))
saveRDS(acq_function, paste0(dir_path, "/acq_function.rds"))
saveRDS(acq_optimizer, paste0(dir_path, "/acq_optimizer.rds"))
# %%